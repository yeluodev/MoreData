package club.moredata.common.util;

import club.moredata.common.db.sql.DateSQLBuilder;
...
public class DateUtil {
    ...
    /**
     * 获取所给时间戳的时间显示文本，形如2019-06-19 22:00:59
     *
     * @param timestamp
     * @return
     */
    ...
    public boolean isTradingDay(long timestamp) {
        ...
        if (weekIndex > 1 && weekIndex < 7) {
            ...
            try {
                ...
                PreparedStatement preparedStatement = connection.prepareStatement(DateSQLBuilder.buildHolidayQuery());
