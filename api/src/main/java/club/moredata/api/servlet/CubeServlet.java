...
import club.moredata.api.model.LeekSearchResult;
import club.moredata.api.model.RebStock;
...
import club.moredata.common.entity.Rebalancing;
...
public class CubeServlet extends BaseServlet {
    ...
    public void dealRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (matchPath) {
            ...
            case "search":
                SearchResult<Cube> searchResult = SyncApi.getInstance().searchCube(key);
            ...
            case "list":
                if (cubeIds == null) {
                    ...
                    copyList.forEach(id -> {
                        SearchResult<Cube> searchRes = SyncApi.getInstance().searchCube(id);
